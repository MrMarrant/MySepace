<template>
  <div>
    ...
    <form class="form bg-white p-6 my-10 relative">
      ...
      <h3 class="text-2xl text-gray-900 font-semibold">Poster un commentaire</h3>
      <input v-model="postComment.auteur" type="text" name="" placeholder="Auteur" class="border p-2  w-1/2">
      <textarea v-model="postComment.contenu" name="" cols="10" rows="3" placeholder="Description"
